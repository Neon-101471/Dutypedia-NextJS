...
const attendenceSystem = (props) => {
    ...
    useEffect(() => {
        console.log('hello this attendance')
        fetch('https://dutychoice.com/app-api/get-attendence/')
        .then(res => res.json())
    ...
    return (
        <Wrapper style={{ width: '90%', margin: 'auto' }} className="wrapper-width bg-white p-4">
            ...
            <div className="attendence-stystem d-lg-flex">
                ...
                <CheckBox  name="Point" onClick={() => setSystem('point')} />
                <CheckBox name="Present" onClick={() => setSystem('percent')} />
            </div>

            <h1>check tailwind</h1>
            {/* Attendence Dates */}
        ...
        attendence per day*/}
            ...
            <div className="bottom-btns">
                <Link  href="/dashboard_1/groups/groupcard/attendance/weeklyAttendence">
                    <button className="cmnBtn border-0 mr-3" onClick={handleCreateAttendance}>Next</button>
                </Link>
