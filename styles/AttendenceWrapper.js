...
/* ---------------------------------------------
------------------ Attendence form table body--------------
---------------------------------------------------- */
.attendence-form-details {
  margin: 10px 0;
  display: flex;
  justify-content: space-between;
}
.attendence-form-person,
.attendence-form-status,
.attendence-point-and-percentage {
...
.attendence-form-image {
  width: 54px;
  height: 54px;
  margin: auto;
  position: relative;
}
.attendence-form-image img {
  width: 100%;
  height: 100%;
  border-radius: 5px;
}
.attendence-form-image .img-bottom-content {
  width: 15px;
  height: 15px;
  background-color: #fff;
...
.attendence-form-status .form-status {
  width: 40%;
  display: flex;
  align-items: center;
  justify-content: center;
}
.attendence-form-status .form-status span {
  width: 30px;
  height: 30px;
  border-radius: 50%;
  box-shadow: 0 0 6px #d6d6d6;
...
.attendence-form-status .form-status span.active:first-child {
  background-color: rgb(246, 27, 27);
  color: white;
}
.attendence-form-status .form-status span.active:nth-child(2) {
  background-color: rgb(36, 181, 26);
  color: white;
}
.attendence-form-status .form-status span.active:last-child {
  background-color: rgb(0, 111, 255);
  color: white;
}
.attendence-form-status .attendence-percentage-and-point {
  width: 60%;
...
.attendence-percentage-and-point .point,
.attendence-percentage-and-point .percentage {
  height: 100%;
  padding-left: 60px;
  padding-right: 40px;
  display: flex;
...
.attendence-point-and-percentage .point,
.attendence-point-and-percentage .percentage {
  height: 100%;
  padding: 0 20px;
  display: flex;
  align-items: center;
...
.att-table-person .person-info {
  padding-left: 20px;
}
.att-table-person .person-info small {
  font-size: 12px;
}
.att-table-status {
  width: 50%;
...
.att-table-status .table-status {
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: center;
}
.att-table-status .table-status span {
  margin: 0 20px;
  font-size: 20px;
  font-weight: 500;
  color: rgb(102, 102, 102);
}
.att-point-and-percentage {
  width: 18%;
  display: flex;
  flex-direction: column;
  justify-content: center;
...
.att-point-and-percentage .point,
.att-point-and-percentage .percentage {
  height: 100%;
  padding: 0 20px;
  display: flex;
  align-items: center;
