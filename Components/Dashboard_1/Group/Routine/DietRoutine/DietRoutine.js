            ...
            {routineName &&
                <div id="created-diet-routine" className="created-diet-routine text-center" onClick={() => setRoutineName(false)} >
                    <div className='d-flex justify-content-center'>
                        <i className="created-diet-routine-plus d-flex justify-content-center">
                            <FaPlus />
                        </i>
                    </div>
                    ...
                    {!routineName && !academy &&
                        <div className="diet-routine-input mt-5">
                            ...
                            <div className="get-user-input">
                                <div className='row'>
                                    <input id="routine-name" placeholder='Give a routine name' type="text" className="user-input-field" style={{ marginLeft: '12px' }} />
                                </div>
                            </div>
                            <div>
                            ...
                            <div className="d-flex btn-bottom mb-5 mt-4">
                                <Link href="/dashboard_1/groups/groupcard/routine/dietRoutine/dietRoutineTable">
                                    <button id={hover ? ' ' : 'diet-routine-next-btn'} className="cmnBtn border-0 me-3">Next</button>
                                </Link>
                                <button id="dietChoosDateCancelBtn" className="cmnBtn" onMouseOver={() => setHover(false)} onMouseOut={() => setHover(true)}>Cancel</button>
                            </div>
                        </div>}
                </div>
            </div>
