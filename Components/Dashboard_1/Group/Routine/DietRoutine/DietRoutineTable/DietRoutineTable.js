...
import StyleSheet from '../StyledDietRoutine/DietRoutineStyle.module.css';
    ...
    return (
        <Wrapper>
                ...
                <div className="accordion-item shadow-sm my-3 border rounded10 col-md-5 px-0">
                    ...
                    <div
                        ...
                        <div className="accordion-body text-start">
                            A MERN stack developer is an expert in MongoDB, Express, React and Node. They are proficient in JavaScript and use HTML, CSS and JavaScript to handle front-end operations and JavaScript with Node. js for back-end operations.
                        </div>
                    </div>
                </div>
            ...
            <div id="diet-routine-table-btn">
                <div className="d-flex btn-bottom justify-content-end diet-routine-bottom-btn mb-5">
                ...
                <div className="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content adjust-time-modal">
                            <h3 className='text-center mt-5' id='choose-day'>Choose Day</h3>
                            <div className='row pt-4'>
                                {/* Saturday */}
                                <div className="d-flex diet-routine-chooseday-checkbox col-6 justify-content-between align-items-center" key="saturday" style={{ fontFamily: 'Aller', fontSize: '28px' }}>
                                    <label htmlFor="saturday" className="diet-routine-checkbox-container" style={{ fontSize: '18px' }}> Saturday
                                        <input id="saturday" type="checkbox" name="saturday" />
                                        <span className={StyleSheet.check_mark}>
                                        </span>
                                    </label>
                                ...
                                {/* Sunday */}
                                <div className="d-flex diet-routine-chooseday-checkbox col-6 d-flex justify-content-between align-items-center" key="sunday" style={{ fontFamily: 'Aller', fontSize: '28px' }}>
                                    <label htmlFor="sunday" className="diet-routine-checkbox-container" style={{ fontSize: '18px' }}> Sunday
                                ...
                                {/* Monday */}
                                <div className="d-flex diet-routine-chooseday-checkbox col-6 d-flex justify-content-between align-items-center" key="monday" style={{ fontFamily: 'Aller', fontSize: '28px' }}>
                                    <label htmlFor="monday" className="diet-routine-checkbox-container" style={{ fontSize: '18px' }}> Monday
                                ...
                                {/* Thursday */}
                                <div className="d-flex diet-routine-chooseday-checkbox col-6 justify-content-between align-items-center" key="tuesday" style={{ fontFamily: 'Aller', fontSize: '28px' }}>
                                    <label htmlFor="tuesday" className="diet-routine-checkbox-container" style={{ fontSize: '18px' }}> Tuesday
                                ...
                                {/* Wednesday */}
                                <div className="d-flex diet-routine-chooseday-checkbox col-6 d-flex justify-content-between align-items-center" key="wednesday" style={{ fontFamily: 'Aller', fontSize: '28px' }}>
                                    <label htmlFor="wednesday" className="diet-routine-checkbox-container" style={{ fontSize: '18px' }}> Wednesday
                                ...
                                {/* Thursday */}
                                <div className="d-flex diet-routine-chooseday-checkbox col-6 justify-content-between align-items-center" key="thursday" style={{ fontFamily: 'Aller', fontSize: '28px' }}>
                                    <label htmlFor="thursday" className="diet-routine-checkbox-container" style={{ fontSize: '18px' }}> Thursday
                                ...
                                {/* Friday */}
                                <div className="d-flex diet-routine-chooseday-checkbox col-6 justify-content-between align-items-center" key="friday" style={{ fontFamily: 'Aller', fontSize: '28px' }}>
                                    <label htmlFor="friday" className="diet-routine-checkbox-container" style={{ fontSize: '18px' }}> Friday
                            ...
                            <div className='d-flex justify-content-end'>
                                <div className='diet-routine-btn-container text-right mt-3'>
                                    <button id={BtnHover ? ' ' : 'create-now-btn'} data-bs-dismiss="modal" className="diet-routine-btn border-0 me-2">Save</button>
                                    <button id="cancelEditDietRoutineBtn" data-bs-dismiss="modal" className="diet-routine-btn diet-routine-cancel-btn" onMouseOver={() => setBtnHover(false)} onMouseOut={() => setBtnHover(true)}>Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
